    ...
    <div class="row">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="row"><?php echo $trainer->trainer_id; ?></th>
                    <td><?php echo $trainer->trainer_name; ?></td>
                    <td><?php echo $trainer->trainer_email; ?></td>
                    <td><?php echo $trainer->trainer_phone; ?></td>
                </tr>
...
<?php /**PATH C:\Users\User\Downloads\drive-download-20210426T000523Z-001\1-source\resources\views/trainers.blade.php ENDPATH**/ ?>